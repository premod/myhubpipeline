...
//Name: bug.ma
//Last modified: Wed, Mar 03, 2010 09:37:41 PM
//Codeset: 1252
requires maya "8.0";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -2.267906008176086 2.0831861208384486 1.2883597681836956 ;
	setAttr ".r" -type "double3" -39.938352711860503 -53.400000000426381 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".ncp" 0.001;
	setAttr ".coi" 3.2749359836875365;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -0.77499179545367447 0.078230398124349732 -0.017372454976422036 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.19758766805288974 100.17683089704677 -0.010154903383889999 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
	setAttr ".rp" -type "double3" 0 2.7755575615628914e-017 -1.4210854715202004e-014 ;
	setAttr ".rpt" -type "double3" 0 -1.4238610290817636e-014 1.4183099139586378e-014 ;
createNode camera -s -n "topShape" -p "top";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.19414207980257;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.26836955606992574 0.21734524499416316 100.13943527695982 ;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.15995694211176 0.013326076189934595 -0.0082678209272660785 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
	setAttr ".rp" -type "double3" 0 0 -1.4210854715202004e-014 ;
	setAttr ".rpt" -type "double3" -1.4210854715202007e-014 0 1.4210854715202032e-014 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 101.17307819883534;
	setAttr ".ow" 1.5796089350788274;
	setAttr ".imn" -type "string" "side";
	setAttr ".den" -type "string" "side_depth";
	setAttr ".man" -type "string" "side_mask";
	setAttr ".tp" -type "double3" -1.0487584708914568 0.5559553541424056 -0.27412050388482834 ;
...
createNode joint -n "Root" -p "bug";
	...
	setAttr ".jo" -type "double3" 90.001073789215866 -88.780146922859927 -90.001073545859313 ;
	setAttr ".dl" yes;
	setAttr ".typ" 1;
	setAttr ".radi" 0.5;
...
createNode joint -n "BackA" -p "Root";
	...
	setAttr ".r" -type "double3" 0 0 -1.6186436432850382 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 5.4085007920761384e-006 5.3360901051378696e-005 7.8209720199433068 ;
	setAttr ".radi" 0.5;
createNode joint -n "BackB" -p "BackA";
	setAttr ".t" -type "double3" 0.18824553795606544 -3.3306690738754696e-016 3.7715122020087475e-016 ;
	setAttr ".r" -type "double3" 3.2705218150777334e-006 4.43372025359412e-006 -11.875016254777105 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 8.2151301116187177e-006 -4.0675500997644418e-005 -3.975693351830397e-015 ;
	setAttr ".typ" 18;
	setAttr ".otp" -type "string" "Chest";
	setAttr ".radi" 0.5;
createNode joint -n "FrontLeg1" -p "BackB";
	setAttr ".t" -type "double3" 0.15952387453320349 -0.077010706906123105 0.11481188947910922 ;
...
createNode joint -n "FrontLeg5" -p "FrontLeg4";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".radi" 0.5;
createNode joint -n "Head" -p "BackB";
	addAttr -ci true -k true -sn "freeOrient" -ln "freeOrient" -dv 1 -min 1 -max 1 
		-at "long";
	setAttr ".t" -type "double3" 0.32451717874770647 -1.1102230246251565e-016 -1.7945557657884827e-015 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -3.166670020890552e-006 8.2386697834926248e-006 2.0673605429513075e-014 ;
	setAttr ".radi" 0.5;
createNode joint -n "Antenna1" -p "Head";
	setAttr ".t" -type "double3" 0.12903474052013647 -0.086575761039120791 0.10006985438447803 ;
...
createNode joint -n "Antenna4" -p "Antenna3";
	...
	setAttr ".r" -type "double3" -1.2701311324306094e-007 0.02315981950183468 0.00062844317348056174 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".radi" 0.5;
...
createNode joint -n "MiddleLeg1" -p "BackA";
	setAttr ".t" -type "double3" 0.10449000421352866 -0.113810842873935 0.16093535827020919 ;
	setAttr ".r" -type "double3" -84.082817378694472 -42.416792660072431 -99.022391521762543 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dl" yes;
	setAttr ".typ" 18;
...
createNode joint -n "MiddleLeg4" -p "MiddleLeg3";
	setAttr ".t" -type "double3" 0.48991914618521165 -2.2204460492503131e-016 -1.9428902930940239e-016 ;
...
createNode joint -n "MiddleLeg5" -p "MiddleLeg4";
	...
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".radi" 0.5;
createNode joint -n "Abdomen1" -p "Root";
	setAttr ".t" -type "double3" -0.0019884446881968665 -4.2341285074631863e-005 7.9352468350502536e-010 ;
	setAttr ".r" -type "double3" -0.001142505937455098 179.99995762398177 -8.4385345051815435 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".radi" 0.5;
createNode joint -n "Abdomen2" -p "Abdomen1";
	setAttr ".t" -type "double3" 0.3583554885424719 1.1102230246251565e-016 -7.0842447576560663e-017 ;
	setAttr ".r" -type "double3" 0.0011422447055222248 8.2857834901082375e-005 -5.8839693917860378 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".radi" 0.5;
createNode joint -n "Abdomen3" -p "Abdomen2";
	setAttr ".t" -type "double3" 0.3797362039513571 0 2.541098841762901e-021 ;
	setAttr ".r" -type "double3" 5.3037736438025721e-007 9.9182985153309309e-006 -6.1219106309836393 ;
	setAttr ".ro" 3;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".radi" 0.5;
createNode joint -n "Abdomen4" -p "Abdomen3";
	setAttr ".t" -type "double3" 0.33656727282739374 0 6.3527471044072525e-022 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 33.452205254522205 -89.999994875170856 -29.976477537075766 ;
	setAttr ".radi" 0.5;
createNode joint -n "BackLeg1" -p "Root";
	setAttr ".t" -type "double3" -0.032607894450540797 -0.093353704573515828 0.19961294873052229 ;
...
createNode joint -n "BackLeg4" -p "BackLeg3";
	setAttr ".t" -type "double3" 0.46923741539209396 0 0 ;
...
connectAttr "BackB.s" "FrontLeg1.is";
...
connectAttr "Root.s" "Abdomen1.is";
connectAttr "Abdomen1.s" "Abdomen2.is";
connectAttr "Abdomen2.s" "Abdomen3.is";
connectAttr "Abdomen3.s" "Abdomen4.is";
